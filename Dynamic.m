...
subName = {'S001R04','S014R04','S031R04','S060R04','S069R04','S089R04','S099R04'......
    'S100R04','S105R04','S106R04'};
...
%     eventLoc = [eventLoc; find(eventTyp==3)];
     % Search for endpoints of the blocks
%     restLoc = find(eventTyp==1);     
%     Ts = header.EVENT.POS(eventLoc-1);
%     Te = header.EVENT.POS(restLoc);
%     [~,sigLength] = size(signal);
%     task_all = {};
%     for i = 1 : length(Ts)
%         task_all{i} = signal(:,Ts(i):Te(i));
%     end
